...
question = {
	"who is our priminister of our india ?": ['Mahatma Gandhi', 'Narendra damodar Das Modi', 'Rahul Gandhi', 'All of These'],
	"What id the full form of RAM ?": ['Random access Memory', 'Read only Memory', 'Random Ability Memory', 'None of These'],
	"How many days are there in a week?": [' 1 days', ' 7 days', ' 2 days', ' 6 days'], " How many consonants are there in the English alphabet?": ['65 Consonants', '16 Consonants', '40 Consonants', '21 Consonants' ]
}
# define answer list
ans = ['Narendra damodar Das Modi', 'Random access Memory', ' 7 days', '21 Consonants']
